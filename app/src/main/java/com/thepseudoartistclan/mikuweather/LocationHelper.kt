...
object LocationHelper {
     ...
     * 获取当前定位
     */
    @RequiresPermission(anyOf = [permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION])
    suspend fun getLocation(context: Activity,timeOut: Long = 2000):Location{
        ...
        Log.d("com.thepseudoartistclan.mikuweather.LocationHelper", "getLocation:$location")
    ...
    private suspend fun getLocationByLocationManager(context: Activity,timeOut: Long = 2000):Location{
        Log.d("com.thepseudoartistclan.mikuweather.LocationHelper", "getLocationByLocationManager")
    ...
    private suspend fun getLocationByFusedLocationProviderClient(context: Activity):Location{
        Log.d("com.thepseudoartistclan.mikuweather.LocationHelper", "getLocationByFusedLocationProviderClient")
